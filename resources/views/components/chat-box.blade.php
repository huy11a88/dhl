    ...
    <div id="chat-box" class="hidden" data-user-id="{{ auth()->id() }}">
        <div class="w-[450px] h-[600px] shadow flex flex-col rounded-xl">
            ...
            <div class="relative p-2 bg-white rounded-xl">
                <input id="chat-message" data-chat-room-id="{{ auth()->user()->room_id }}" type="text" class="block w-full rounded-xl border-slate-200 focus:border-slate-200 focus:ring-0" name="chat-message" placeholder="Feel free to ask" />
